// resend-notify.js — JobberInvoice LP
// Required env vars: RESEND_API_KEY, RESEND_FROM_EMAIL, CONTACT_EMAIL
// RESEND_SEGMENT_ID defaults to the JobberInvoice waitlist segment if not overridden.

const PRODUCT_SEGMENT_ID = 'c8fc5e12-d3ae-4214-9f65-247f30246b19'; // Waitlist-JobberInvoice
...
module.exports = async function handler(req, res) {
  ...
  const productName = product || 'JobberInvoice';
